...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "heneeshhoney@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Elite Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Elite Electronics.<br>"
					...
					+ "<span class='greenText'>Elite500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
